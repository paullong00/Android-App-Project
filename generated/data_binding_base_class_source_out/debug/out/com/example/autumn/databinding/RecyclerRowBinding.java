...
public final class RecyclerRowBinding implements ViewBinding {
  ...
  private RecyclerRowBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView,
  ...
  public static RecyclerRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerRowBinding((ConstraintLayout) rootView, textView, textView2, textView3);
    }
